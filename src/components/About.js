...
const About = () => {
  return (
    <main className='w-full min-h-screen bg-bg-img bg-cover'>
     ...
     <div className='flex flex-col items-center justify-center mt-32  text-gray-300 bg-black mx-20 '>
       <p className='text-3xl mt-20'>Welcome to our TODO APPLICATION</p>
       <p className='text-3xl mt-10 mb-20 mx-40  text-blue-700 font-semibold tracking-wide '>I am a web developer with 4+ years of experience in React. I have a strong foundation in front-end & back-end development and am skilled in creating user-friendly and responsive web applications using React and its ecosystem. I have experience working on a variety of projects, including building and maintaining single page applications, integrating with REST APIs, and implementing responsive design principles. I am also proficient in using tools such as Webpack, npm, and Git for development and deployment. In addition to my technical skills, I am a strong communicator and team player. I am able to work effectively with cross-functional teams and am comfortable taking on new challenges and learning new technologies as needed.
